...
def test_check():
	purchase_orders = frappe.db.get_all("Purchase Order", pluck="name")
	for purchase_order in purchase_orders:
		job_order = frappe.db.get_value("Purchase Order", purchase_order, "custom_is_jobcard__subcontracted")
		if job_order:
			frappe.db.set_value("Purchase Order", purchase_order, "custom_po_type", "Job Order")
		else:
			frappe.db.set_value("Purchase Order", purchase_order, "custom_po_type", "Purchase Order")